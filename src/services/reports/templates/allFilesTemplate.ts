...
export function generateAllFilesHtmlTemplate(files: File["fileInfo"][]): string {
    ...
    <div style="width: 100%; box-sizing: border-box; padding: 30px; font-family: 'Almarai', sans-serif; direction: rtl; background-color: #ffffff; color: #111827;">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-bottom: 22px;">
            <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-top: 3px solid #8b1e1e; padding: 10px; border-radius: 8px; text-align: center;">
                <div style="font-size: 11px; color: #6b7280; font-weight: 600;">إجمالي الملفات</div>
                <div style="font-size: 17px; font-weight: 800; color: #8b1e1e; margin-top: 4px;">${totalFiles}</div>
            </div>
            <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-top: 3px solid #0284c7; padding: 10px; border-radius: 8px; text-align: center;">
                <div style="font-size: 11px; color: #6b7280; font-weight: 600;">ملفات الأفراد</div>
                <div style="font-size: 17px; font-weight: 800; color: #0369a1; margin-top: 4px;">${individualCount}</div>
            </div>
            <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-top: 3px solid #059669; padding: 10px; border-radius: 8px; text-align: center;">
                <div style="font-size: 11px; color: #6b7280; font-weight: 600;">ملفات الشركات</div>
                <div style="font-size: 17px; font-weight: 800; color: #047857; margin-top: 4px;">${companyCount}</div>
            </div>
            <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-top: 3px solid #d97706; padding: 10px; border-radius: 8px; text-align: center;">
                <div style="font-size: 11px; color: #6b7280; font-weight: 600;">شركات خيرية</div>
                <div style="font-size: 17px; font-weight: 800; color: #b45309; margin-top: 4px;">${charitableCount}</div>
            </div>
        </div>
