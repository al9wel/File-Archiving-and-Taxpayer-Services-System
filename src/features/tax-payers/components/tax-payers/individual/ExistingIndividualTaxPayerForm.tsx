...
type ExistingIndividualTaxPayerFormValues = z.infer<typeof additionalInfoSchema>

interface ExistingIndividualTaxPayerFormProps {
...
export const ExistingIndividualTaxPayerForm = ({ onSubmit, isLoading }: ExistingIndividualTaxPayerFormProps) => {
    ...
    const { register, handleSubmit, setValue, watch, formState: { errors } } = useForm<ExistingIndividualTaxPayerFormValues>({
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, fieldName: keyof ExistingIndividualTaxPayerFormValues, setter: (val: string | null) => void) => {
    ...
    const handleFormSubmit = (values: ExistingIndividualTaxPayerFormValues) => {
        ...
        fields.forEach(fieldName => {
            const value = values[fieldName as keyof ExistingIndividualTaxPayerFormValues]
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-8" dir="rtl">
            <Card className="p-8 rounded-3xl border shadow-sm space-y-8">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-bold">ربط مستخدم موجود</h2>
                </div>
