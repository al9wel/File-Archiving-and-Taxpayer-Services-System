...
export const DepartmentActions = ({ department }: DepartmentActionsProps) => {
  ...
  const canUpdate = usePermission(ACTIONS.UPDATE_DEPARTMENT);
  const canDelete = usePermission(ACTIONS.DELETE_DEPARTMENT);
  ...
  const handleDelete = () => {
    ...
    const targetDept = departments?.data?.find(
    ...
    moveUsers(
      { oldId: department.id, newId: targetDept.id },
      {
        onSuccess: () => {
          ...
          >
            ...
            <div className="space-y-4 text-right">
              <p className="text-sm text-muted-foreground">
                حذف القسم سيؤثر على المستخدمين المرتبطين به. اختر أحد الخيارات
                أدناه.
              </p>
              <div
              ...
              >
                <h3 className="font-semibold">
                  حذف القسم مع جميع المستخدمين المرتبطين
                </h3>
                <p className="text-sm text-muted-foreground">
                  سيتم حذف القسم وجميع المستخدمين المرتبطين به نهائياً.
                </p>
              </div>
              <div
              ...
              >
                <h3 className="font-semibold">
                  نقل المستخدمين لقسم آخر ثم الحذف
                </h3>
                <p className="text-sm text-muted-foreground">
                  اختر قسماً لاستقبال المستخدمين ثم سيتم حذف القسم الحالي.
                </p>
                {deleteOption === "move" && (
                  <div className="mt-3">
